...
└── Back/
    ...
    │   └── Soybean_Diseases_Dataset/ # v2.0 (609 imgs)
    │
...
### 🔮 v3.0 - Mobile & Expansão
- [ ] Aplicativo móvel (Flutter/React Native)
- [ ] Detecção de pragas (lagartas, percevejos)
- [ ] Mais datasets de doenças
...
| Modelo | Classes | Dataset | Acurácia |
|--------|---------|---------|----------|
| v1.0 | 2 | 3.720 imgs | ~85% |
| v2.0 | 10 | 609 imgs | ~65%* |
| Cascata | 2→10 | Combinado | Melhor precisão |

*v2.0 limitado pelo tamanho do dataset
